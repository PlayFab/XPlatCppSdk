...
namespace PlayFab
{
    const std::string PlayFabSettings::sdkVersion = "2.9.180809";
    const std::string PlayFabSettings::buildIdentifier = "jbuild_xplatcppsdk_sdk-slave2016-2_0";
    const std::string PlayFabSettings::versionString = "XPlatCppSdk-2.9.180809";
