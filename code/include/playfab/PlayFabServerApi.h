...
namespace PlayFab
{
    ...
    public:
        ...
        static void GetPlayFabIDsFromBattleNetAccountIds(ServerModels::GetPlayFabIDsFromBattleNetAccountIdsRequest& request, const ProcessApiCallback<ServerModels::GetPlayFabIDsFromBattleNetAccountIdsResult> callback, const ErrorCallback errorCallback = nullptr, void* customData = nullptr);
        ...
        static void GetPlayFabIDsFromOpenIdSubjectIdentifiers(ServerModels::GetPlayFabIDsFromOpenIdsRequest& request, const ProcessApiCallback<ServerModels::GetPlayFabIDsFromOpenIdsResult> callback, const ErrorCallback errorCallback = nullptr, void* customData = nullptr);
        ...
        static void LinkBattleNetAccount(ServerModels::LinkBattleNetAccountRequest& request, const ProcessApiCallback<ServerModels::EmptyResult> callback, const ErrorCallback errorCallback = nullptr, void* customData = nullptr);
        ...
        static void LinkTwitchAccount(ServerModels::LinkTwitchAccountRequest& request, const ProcessApiCallback<ServerModels::EmptyResult> callback, const ErrorCallback errorCallback = nullptr, void* customData = nullptr);
        ...
        static void LinkXboxId(ServerModels::LinkXboxIdRequest& request, const ProcessApiCallback<ServerModels::LinkXboxAccountResult> callback, const ErrorCallback errorCallback = nullptr, void* customData = nullptr);
        ...
        static void LoginWithAndroidDeviceID(ServerModels::LoginWithAndroidDeviceIDRequest& request, const ProcessApiCallback<ServerModels::ServerLoginResult> callback, const ErrorCallback errorCallback = nullptr, void* customData = nullptr);
        static void LoginWithBattleNet(ServerModels::LoginWithBattleNetRequest& request, const ProcessApiCallback<ServerModels::ServerLoginResult> callback, const ErrorCallback errorCallback = nullptr, void* customData = nullptr);
        static void LoginWithCustomID(ServerModels::LoginWithCustomIDRequest& request, const ProcessApiCallback<ServerModels::ServerLoginResult> callback, const ErrorCallback errorCallback = nullptr, void* customData = nullptr);
        static void LoginWithIOSDeviceID(ServerModels::LoginWithIOSDeviceIDRequest& request, const ProcessApiCallback<ServerModels::ServerLoginResult> callback, const ErrorCallback errorCallback = nullptr, void* customData = nullptr);
        ...
        static void LoginWithTwitch(ServerModels::LoginWithTwitchRequest& request, const ProcessApiCallback<ServerModels::ServerLoginResult> callback, const ErrorCallback errorCallback = nullptr, void* customData = nullptr);
        ...
        static void UnlinkBattleNetAccount(ServerModels::UnlinkBattleNetAccountRequest& request, const ProcessApiCallback<ServerModels::EmptyResponse> callback, const ErrorCallback errorCallback = nullptr, void* customData = nullptr);
        ...
        static void UnlinkTwitchAccount(ServerModels::UnlinkTwitchAccountRequest& request, const ProcessApiCallback<ServerModels::EmptyResult> callback, const ErrorCallback errorCallback = nullptr, void* customData = nullptr);
    ...
    private:
        ...
        static void OnGetPlayFabIDsFromBattleNetAccountIdsResult(int httpCode, const std::string& result, const std::shared_ptr<CallRequestContainerBase>& reqContainer);
        ...
        static void OnGetPlayFabIDsFromOpenIdSubjectIdentifiersResult(int httpCode, const std::string& result, const std::shared_ptr<CallRequestContainerBase>& reqContainer);
        ...
        static void OnLinkTwitchAccountResult(int httpCode, const std::string& result, const std::shared_ptr<CallRequestContainerBase>& reqContainer);
        ...
        static void OnLinkXboxIdResult(int httpCode, const std::string& result, const std::shared_ptr<CallRequestContainerBase>& reqContainer);
        ...
        static void OnLoginWithBattleNetResult(int httpCode, const std::string& result, const std::shared_ptr<CallRequestContainerBase>& reqContainer);
        ...
        static void OnUnlinkTwitchAccountResult(int httpCode, const std::string& result, const std::shared_ptr<CallRequestContainerBase>& reqContainer);
