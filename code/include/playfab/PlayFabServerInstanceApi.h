...
namespace PlayFab
{
    ...
    public:
        ...
        void DeletePlayerCustomProperties(ServerModels::DeletePlayerCustomPropertiesRequest& request, const ProcessApiCallback<ServerModels::DeletePlayerCustomPropertiesResult> callback, const ErrorCallback errorCallback = nullptr, void* customData = nullptr);
        ...
        void GetPlayerCustomProperty(ServerModels::GetPlayerCustomPropertyRequest& request, const ProcessApiCallback<ServerModels::GetPlayerCustomPropertyResult> callback, const ErrorCallback errorCallback = nullptr, void* customData = nullptr);
        ...
        void GetPlayFabIDsFromBattleNetAccountIds(ServerModels::GetPlayFabIDsFromBattleNetAccountIdsRequest& request, const ProcessApiCallback<ServerModels::GetPlayFabIDsFromBattleNetAccountIdsResult> callback, const ErrorCallback errorCallback = nullptr, void* customData = nullptr);
        ...
        void GetPlayFabIDsFromOpenIdSubjectIdentifiers(ServerModels::GetPlayFabIDsFromOpenIdsRequest& request, const ProcessApiCallback<ServerModels::GetPlayFabIDsFromOpenIdsResult> callback, const ErrorCallback errorCallback = nullptr, void* customData = nullptr);
        ...
        void GetPlayFabIDsFromSteamNames(ServerModels::GetPlayFabIDsFromSteamNamesRequest& request, const ProcessApiCallback<ServerModels::GetPlayFabIDsFromSteamNamesResult> callback, const ErrorCallback errorCallback = nullptr, void* customData = nullptr);
        ...
        void LinkBattleNetAccount(ServerModels::LinkBattleNetAccountRequest& request, const ProcessApiCallback<ServerModels::EmptyResult> callback, const ErrorCallback errorCallback = nullptr, void* customData = nullptr);
        void LinkNintendoServiceAccount(ServerModels::LinkNintendoServiceAccountRequest& request, const ProcessApiCallback<ServerModels::EmptyResult> callback, const ErrorCallback errorCallback = nullptr, void* customData = nullptr);
        void LinkNintendoServiceAccountSubject(ServerModels::LinkNintendoServiceAccountSubjectRequest& request, const ProcessApiCallback<ServerModels::EmptyResult> callback, const ErrorCallback errorCallback = nullptr, void* customData = nullptr);
        void LinkNintendoSwitchDeviceId(ServerModels::LinkNintendoSwitchDeviceIdRequest& request, const ProcessApiCallback<ServerModels::LinkNintendoSwitchDeviceIdResult> callback, const ErrorCallback errorCallback = nullptr, void* customData = nullptr);
        ...
        void LinkPSNId(ServerModels::LinkPSNIdRequest& request, const ProcessApiCallback<ServerModels::LinkPSNIdResponse> callback, const ErrorCallback errorCallback = nullptr, void* customData = nullptr);
        ...
        void LinkTwitchAccount(ServerModels::LinkTwitchAccountRequest& request, const ProcessApiCallback<ServerModels::EmptyResult> callback, const ErrorCallback errorCallback = nullptr, void* customData = nullptr);
        ...
        void LinkXboxId(ServerModels::LinkXboxIdRequest& request, const ProcessApiCallback<ServerModels::LinkXboxAccountResult> callback, const ErrorCallback errorCallback = nullptr, void* customData = nullptr);
        void ListPlayerCustomProperties(ServerModels::ListPlayerCustomPropertiesRequest& request, const ProcessApiCallback<ServerModels::ListPlayerCustomPropertiesResult> callback, const ErrorCallback errorCallback = nullptr, void* customData = nullptr);
        void LoginWithAndroidDeviceID(ServerModels::LoginWithAndroidDeviceIDRequest& request, const ProcessApiCallback<ServerModels::ServerLoginResult> callback, const ErrorCallback errorCallback = nullptr, void* customData = nullptr);
        void LoginWithBattleNet(ServerModels::LoginWithBattleNetRequest& request, const ProcessApiCallback<ServerModels::ServerLoginResult> callback, const ErrorCallback errorCallback = nullptr, void* customData = nullptr);
        void LoginWithCustomID(ServerModels::LoginWithCustomIDRequest& request, const ProcessApiCallback<ServerModels::ServerLoginResult> callback, const ErrorCallback errorCallback = nullptr, void* customData = nullptr);
        void LoginWithIOSDeviceID(ServerModels::LoginWithIOSDeviceIDRequest& request, const ProcessApiCallback<ServerModels::ServerLoginResult> callback, const ErrorCallback errorCallback = nullptr, void* customData = nullptr);
        ...
        void LoginWithTwitch(ServerModels::LoginWithTwitchRequest& request, const ProcessApiCallback<ServerModels::ServerLoginResult> callback, const ErrorCallback errorCallback = nullptr, void* customData = nullptr);
        ...
        void UnlinkBattleNetAccount(ServerModels::UnlinkBattleNetAccountRequest& request, const ProcessApiCallback<ServerModels::EmptyResponse> callback, const ErrorCallback errorCallback = nullptr, void* customData = nullptr);
        void UnlinkNintendoServiceAccount(ServerModels::UnlinkNintendoServiceAccountRequest& request, const ProcessApiCallback<ServerModels::EmptyResponse> callback, const ErrorCallback errorCallback = nullptr, void* customData = nullptr);
        void UnlinkNintendoSwitchDeviceId(ServerModels::UnlinkNintendoSwitchDeviceIdRequest& request, const ProcessApiCallback<ServerModels::UnlinkNintendoSwitchDeviceIdResult> callback, const ErrorCallback errorCallback = nullptr, void* customData = nullptr);
        ...
        void UnlinkSteamId(ServerModels::UnlinkSteamIdRequest& request, const ProcessApiCallback<ServerModels::UnlinkSteamIdResult> callback, const ErrorCallback errorCallback = nullptr, void* customData = nullptr);
        void UnlinkTwitchAccount(ServerModels::UnlinkTwitchAccountRequest& request, const ProcessApiCallback<ServerModels::EmptyResult> callback, const ErrorCallback errorCallback = nullptr, void* customData = nullptr);
        ...
        void UpdatePlayerCustomProperties(ServerModels::UpdatePlayerCustomPropertiesRequest& request, const ProcessApiCallback<ServerModels::UpdatePlayerCustomPropertiesResult> callback, const ErrorCallback errorCallback = nullptr, void* customData = nullptr);
        ...
        void OnGetPlayFabIDsFromBattleNetAccountIdsResult(int httpCode, const std::string& result, const std::shared_ptr<CallRequestContainerBase>& reqContainer);
        ...
        void OnGetPlayFabIDsFromOpenIdSubjectIdentifiersResult(int httpCode, const std::string& result, const std::shared_ptr<CallRequestContainerBase>& reqContainer);
        ...
        void OnLinkBattleNetAccountResult(int httpCode, const std::string& result, const std::shared_ptr<CallRequestContainerBase>& reqContainer);
        ...
        void OnLinkNintendoServiceAccountSubjectResult(int httpCode, const std::string& result, const std::shared_ptr<CallRequestContainerBase>& reqContainer);
        ...
        void OnLinkPSNIdResult(int httpCode, const std::string& result, const std::shared_ptr<CallRequestContainerBase>& reqContainer);
        ...
        void OnLinkTwitchAccountResult(int httpCode, const std::string& result, const std::shared_ptr<CallRequestContainerBase>& reqContainer);
        ...
        void OnLinkXboxIdResult(int httpCode, const std::string& result, const std::shared_ptr<CallRequestContainerBase>& reqContainer);
        ...
        void OnLoginWithBattleNetResult(int httpCode, const std::string& result, const std::shared_ptr<CallRequestContainerBase>& reqContainer);
        ...
        void OnUnlinkBattleNetAccountResult(int httpCode, const std::string& result, const std::shared_ptr<CallRequestContainerBase>& reqContainer);
        ...
        void OnUnlinkSteamIdResult(int httpCode, const std::string& result, const std::shared_ptr<CallRequestContainerBase>& reqContainer);
        void OnUnlinkTwitchAccountResult(int httpCode, const std::string& result, const std::shared_ptr<CallRequestContainerBase>& reqContainer);
