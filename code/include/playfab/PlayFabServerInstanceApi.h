...
namespace PlayFab
{
    ...
    public:
        ...
        PlayFabServerInstanceAPI(std::shared_ptr<PlayFabApiSettings> apiSettings);
        PlayFabServerInstanceAPI(std::shared_ptr<PlayFabAuthenticationContext> authenticationContext);
