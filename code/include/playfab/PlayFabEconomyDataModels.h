...
namespace PlayFab
{
    namespace EconomyModels
    {
        ...
        struct AddInventoryItemsResponse : public PlayFabResultCommon
        {
            ...
            std::list<InventoryItem> UpdatedItems;
            ...
            void FromJson(const Json::Value& input) override
            {
                ...
                FromJsonUtilO(input["UpdatedItems"], UpdatedItems);
            }
            ...
            Json::Value ToJson() const override
            {
                ...
                Json::Value each_UpdatedItems; ToJsonUtilO(UpdatedItems, each_UpdatedItems); output["UpdatedItems"] = each_UpdatedItems;
                return output;
            }
        };
