...
namespace PlayFab
{
    ...
    public:
        ...
        PlayFabAdminInstanceAPI(std::shared_ptr<PlayFabApiSettings> apiSettings);
        PlayFabAdminInstanceAPI(std::shared_ptr<PlayFabAuthenticationContext> authenticationContext);
