...
namespace PlayFab
{
    ...
    private:
        ...
        static void OnActivateKeyResult(int httpCode, std::string result, std::unique_ptr<CallRequestContainerBase> reqContainer);
        static void OnCreateKeyResult(int httpCode, std::string result, std::unique_ptr<CallRequestContainerBase> reqContainer);
        static void OnDeactivateKeyResult(int httpCode, std::string result, std::unique_ptr<CallRequestContainerBase> reqContainer);
        static void OnDeleteKeyResult(int httpCode, std::string result, std::unique_ptr<CallRequestContainerBase> reqContainer);
        static void OnGetEntityTokenResult(int httpCode, std::string result, std::unique_ptr<CallRequestContainerBase> reqContainer);
        static void OnGetKeysResult(int httpCode, std::string result, std::unique_ptr<CallRequestContainerBase> reqContainer);
