...
namespace PlayFab
{
    ...
    public:
        ...
        void LinkNintendoAccount(ClientModels::LinkNintendoAccountRequest& request, const ProcessApiCallback<ClientModels::EmptyResult> callback, const ErrorCallback errorCallback = nullptr, void* customData = nullptr);
        ...
        void LoginWithNintendoAccount(ClientModels::LoginWithNintendoAccountRequest& request, const ProcessApiCallback<ClientModels::LoginResult> callback, const ErrorCallback errorCallback = nullptr, void* customData = nullptr);
        ...
        void UnlinkNintendoAccount(ClientModels::UnlinkNintendoAccountRequest& request, const ProcessApiCallback<ClientModels::EmptyResponse> callback, const ErrorCallback errorCallback = nullptr, void* customData = nullptr);
        ...
        void OnLinkNintendoAccountResult(int httpCode, const std::string& result, const std::shared_ptr<CallRequestContainerBase>& reqContainer);
        ...
        void OnLoginWithNintendoAccountResult(int httpCode, const std::string& result, const std::shared_ptr<CallRequestContainerBase>& reqContainer);
        ...
        void OnUnlinkNintendoAccountResult(int httpCode, const std::string& result, const std::shared_ptr<CallRequestContainerBase>& reqContainer);
