...
namespace PlayFab
{
    ...
    public:
        ...
        void GetPlayFabIDsFromBattleNetAccountIds(ClientModels::GetPlayFabIDsFromBattleNetAccountIdsRequest& request, const ProcessApiCallback<ClientModels::GetPlayFabIDsFromBattleNetAccountIdsResult> callback, const ErrorCallback errorCallback = nullptr, void* customData = nullptr);
        ...
        void GetPlayFabIDsFromGooglePlayGamesPlayerIDs(ClientModels::GetPlayFabIDsFromGooglePlayGamesPlayerIDsRequest& request, const ProcessApiCallback<ClientModels::GetPlayFabIDsFromGooglePlayGamesPlayerIDsResult> callback, const ErrorCallback errorCallback = nullptr, void* customData = nullptr);
        ...
        void GetPlayFabIDsFromOpenIdSubjectIdentifiers(ClientModels::GetPlayFabIDsFromOpenIdsRequest& request, const ProcessApiCallback<ClientModels::GetPlayFabIDsFromOpenIdsResult> callback, const ErrorCallback errorCallback = nullptr, void* customData = nullptr);
        ...
        void LinkBattleNetAccount(ClientModels::LinkBattleNetAccountRequest& request, const ProcessApiCallback<ClientModels::EmptyResponse> callback, const ErrorCallback errorCallback = nullptr, void* customData = nullptr);
        ...
        void LinkGooglePlayGamesServicesAccount(ClientModels::LinkGooglePlayGamesServicesAccountRequest& request, const ProcessApiCallback<ClientModels::LinkGooglePlayGamesServicesAccountResult> callback, const ErrorCallback errorCallback = nullptr, void* customData = nullptr);
        ...
        void LoginWithBattleNet(ClientModels::LoginWithBattleNetRequest& request, const ProcessApiCallback<ClientModels::LoginResult> callback, const ErrorCallback errorCallback = nullptr, void* customData = nullptr);
        ...
        void LoginWithGooglePlayGamesServices(ClientModels::LoginWithGooglePlayGamesServicesRequest& request, const ProcessApiCallback<ClientModels::LoginResult> callback, const ErrorCallback errorCallback = nullptr, void* customData = nullptr);
        ...
        void UnlinkBattleNetAccount(ClientModels::UnlinkBattleNetAccountRequest& request, const ProcessApiCallback<ClientModels::EmptyResponse> callback, const ErrorCallback errorCallback = nullptr, void* customData = nullptr);
        ...
        void UnlinkGooglePlayGamesServicesAccount(ClientModels::UnlinkGooglePlayGamesServicesAccountRequest& request, const ProcessApiCallback<ClientModels::UnlinkGooglePlayGamesServicesAccountResult> callback, const ErrorCallback errorCallback = nullptr, void* customData = nullptr);
        ...
        void OnGetPlayFabIDsFromGooglePlayGamesPlayerIDsResult(int httpCode, const std::string& result, const std::shared_ptr<CallRequestContainerBase>& reqContainer);
        ...
        void OnLinkGooglePlayGamesServicesAccountResult(int httpCode, const std::string& result, const std::shared_ptr<CallRequestContainerBase>& reqContainer);
        ...
        void OnLoginWithGooglePlayGamesServicesResult(int httpCode, const std::string& result, const std::shared_ptr<CallRequestContainerBase>& reqContainer);
        ...
        void OnUnlinkGooglePlayGamesServicesAccountResult(int httpCode, const std::string& result, const std::shared_ptr<CallRequestContainerBase>& reqContainer);
