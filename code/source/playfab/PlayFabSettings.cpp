...
namespace PlayFab
{
    ...
    const std::string PlayFabSettings::sdkVersion = "3.59.211012";
    const std::string PlayFabSettings::buildIdentifier = "jbuild_xplatcppsdk_sdk-generic-2_1";
    const std::string PlayFabSettings::versionString = "XPlatCppSdk-3.59.211012";
