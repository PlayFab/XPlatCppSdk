...
namespace PlayFab
{
    ...
    const std::string PlayFabSettings::sdkVersion = "3.49.210406";
    const std::string PlayFabSettings::buildIdentifier = "jbuild_xplatcppsdk_sdk-generic-2_0";
    const std::string PlayFabSettings::versionString = "XPlatCppSdk-3.49.210406";
