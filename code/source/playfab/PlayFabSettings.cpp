...
namespace PlayFab
{
    ...
    const std::string PlayFabSettings::sdkVersion = "3.46.210125";
    const std::string PlayFabSettings::buildIdentifier = "jbuild_xplatcppsdk_sdk-genericslave-1_2";
    const std::string PlayFabSettings::versionString = "XPlatCppSdk-3.46.210125";
