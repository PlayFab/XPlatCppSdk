...
namespace PlayFab
{
    ...
    void PlayFabAuthenticationAPI::AuthenticateGameServerWithCustomId(
        AuthenticateCustomIdRequest& request,
        const ProcessApiCallback<AuthenticateCustomIdResult> callback,
    ...
    )
    {
        ...
        auto reqContainer = std::unique_ptr<CallRequestContainer>(new CallRequestContainer(
            ...
            headers,
            jsonAsString,
            OnAuthenticateGameServerWithCustomIdResult,
            settings,
            context,
            customData));

        reqContainer->successCallback = std::shared_ptr<void>((callback == nullptr) ? nullptr : new ProcessApiCallback<AuthenticateCustomIdResult>(callback));
        reqContainer->errorCallback = errorCallback;

        http.MakePostRequest(std::unique_ptr<CallRequestContainerBase>(static_cast<CallRequestContainerBase*>(reqContainer.release())));
    }

    void PlayFabAuthenticationAPI::OnAuthenticateGameServerWithCustomIdResult(int /*httpCode*/, const std::string& /*result*/, const std::shared_ptr<CallRequestContainerBase>& reqContainer)
    {
        ...
        if (ValidateResult(outResult, container))
        {
            ...
            {
                const auto& callback = (*static_cast<ProcessApiCallback<AuthenticateCustomIdResult> *>(internalPtr.get()));
                callback(outResult, container.GetCustomData());
            }
        }
    }

    void PlayFabAuthenticationAPI::Delete(
    ...
    void PlayFabAuthenticationAPI::OnDeleteResult(int /*httpCode*/, const std::string& /*result*/, const std::shared_ptr<CallRequestContainerBase>& reqContainer)
    {
        CallRequestContainer& container = static_cast<CallRequestContainer&>(*reqContainer);
        std::shared_ptr<PlayFabAuthenticationContext> context = container.GetContext();
