...
namespace PlayFab
{
    ...
    void PlayFabAuthenticationInstanceAPI::AuthenticateGameServerWithCustomId(
    ...
    )
    {
        ...
        auto reqContainer = std::unique_ptr<CallRequestContainer>(new CallRequestContainer(
            ...
            headers,
            jsonAsString,
            std::bind(&PlayFabAuthenticationInstanceAPI::OnAuthenticateGameServerWithCustomIdResult, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3),
            settings,
            context,
            customData));
    ...
    void PlayFabAuthenticationInstanceAPI::OnAuthenticateGameServerWithCustomIdResult(int /*httpCode*/, const std::string& /*result*/, const std::shared_ptr<CallRequestContainerBase>& reqContainer)
    {
