...
namespace PlayFab
{
    ...
    void PlayFabAdminAPI::SetTitleInternalDataAndOverrides(
        SetTitleDataAndOverridesRequest& request,
        const ProcessApiCallback<SetTitleDataAndOverridesResult> callback,
        const ErrorCallback errorCallback,
        void* customData
    )
    {
        ...
        auto reqContainer = std::unique_ptr<CallRequestContainer>(new CallRequestContainer(
            ...
            headers,
            jsonAsString,
            OnSetTitleInternalDataAndOverridesResult,
            settings,
            context,
            customData));
    ...
    void PlayFabAdminAPI::OnSetTitleInternalDataAndOverridesResult(int /*httpCode*/, const std::string& /*result*/, const std::shared_ptr<CallRequestContainerBase>& reqContainer)
    {
        CallRequestContainer& container = static_cast<CallRequestContainer&>(*reqContainer);
        std::shared_ptr<PlayFabAuthenticationContext> context = container.GetContext();
