...
namespace PlayFab
{
    ...
    void PlayFabProgressionInstanceAPI::UnlinkAggregationSourceFromStatistic(
    ...
    )
    {
        ...
        auto reqContainer = std::unique_ptr<CallRequestContainer>(new CallRequestContainer(
            ...
            headers,
            jsonAsString,
            std::bind(&PlayFabProgressionInstanceAPI::OnUnlinkAggregationSourceFromStatisticResult, this, std::placeholders::_1, std::placeholders::_2, std::placeholders::_3),
            settings,
            context,
            customData));
    ...
    void PlayFabProgressionInstanceAPI::OnUnlinkAggregationSourceFromStatisticResult(int /*httpCode*/, const std::string& /*result*/, const std::shared_ptr<CallRequestContainerBase>& reqContainer)
    {
        CallRequestContainer& container = static_cast<CallRequestContainer&>(*reqContainer);
        std::shared_ptr<PlayFabAuthenticationContext> context = container.GetContext();
