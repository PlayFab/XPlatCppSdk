...
our %target = (
  ...
  ex_libs => "../deps-release/lib/zlib.lib ws2_32.lib gdi32.lib advapi32.lib crypt32.lib user32.lib",
  exe_extension => "",
  ld => "link",
  lflags => "/nologo /debug",
...
our %withargs = (
  zlib_include => "../deps-release/include/",
  zlib_lib => "../deps-release/lib/zlib.lib",
);
